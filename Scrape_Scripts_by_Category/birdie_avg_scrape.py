...
docTitle = 'birdie_avg'
url = 'https://www.pgatour.com/stats/stat.156.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                stat_data.append([year_id,rank,player_name,rounds,avg,num_birdies,total_rounds])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','birdie_avg','num_birdies','total_rounds'])
