...
docTitle = 'birdie_or_better_conversion'
url = 'https://www.pgatour.com/stats/stat.115.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','conversion_pct','birdies_from_green','greens_hit'])
