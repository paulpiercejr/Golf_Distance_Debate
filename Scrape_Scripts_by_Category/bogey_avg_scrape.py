...
docTitle = 'bogey_avg'
url = 'https://www.pgatour.com/stats/stat.02419.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #print(player_name)
                events = stat_record[3]
                #print(rounds)
                avg_bogey_per_rd = stat_record[4]
                #print(sg_app_green_avg)
                total_bogeys = stat_record[5]
                #print(total_sg_app_green)
                total_rounds = stat_record[6]
                #print(measured_rounds)
                stat_data.append([year_id,rank,player_name,events,avg_bogey_per_rd,total_bogeys,total_rounds])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','events','avg_bogey_per_round','total_bogeys','total_rounds'])
