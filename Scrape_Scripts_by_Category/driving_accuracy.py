...
docTitle = 'driving_accuracy'
url = 'https://www.pgatour.com/stats/stat.102.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #print(rounds)
                accuracy_percent = stat_record[4]
                #print(sg_app_green_avg)
                fairways_hit = stat_record[5]
                #print(total_sg_app_green)
                possible_fairways = stat_record[6]
                #print(measured_rounds)
                stat_data.append([year_id,rank,player_name,rounds,accuracy_percent,fairways_hit,possible_fairways])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','accuracy_percent','fairways_hit','possible_fairways'])
