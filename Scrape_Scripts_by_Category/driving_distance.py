...
docTitle = 'driving_distance'
url = 'https://www.pgatour.com/stats/stat.101.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #print(rounds)
                distance_avg = stat_record[4]
                #print(sg_app_green_avg)
                total_distance = stat_record[5]
                #print(total_sg_app_green)
                total_drives = stat_record[6]
                #print(measured_rounds)
                stat_data.append([year_id,rank,player_name,rounds,distance_avg,total_distance,total_drives])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','distance_avg','total_distance','total_drives'])
