...
docTitle = 'green_or_fringe_regulation'
url = 'https://www.pgatour.com/stats/stat.02437.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','g_or_f_in_reg_percent','total_g_or_f_hit','total_g_or_f_att','rtp_score'])
