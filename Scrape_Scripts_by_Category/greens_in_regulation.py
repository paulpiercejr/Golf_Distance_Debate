...
docTitle = 'greens_in_regulation'
url = 'https://www.pgatour.com/stats/stat.103.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','gir_percent','total_greens_hit','total_greens_att','rtp_score'])
