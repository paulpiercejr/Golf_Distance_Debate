...
docTitle = 'greens_in_regulation_fairway'
url = 'https://www.pgatour.com/stats/stat.190.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #d7 = stat_record[7]
                #d8 = stat_record[8]
                stat_data.append([year_id,rank,player_name,rounds,d4,d5,d6])#,d8])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','gir_percent','total_greens_hit','num_holes'])
