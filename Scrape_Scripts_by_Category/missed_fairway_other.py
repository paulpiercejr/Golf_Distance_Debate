...
docTitle = 'missed_fairway_other'
url = 'https://www.pgatour.com/stats/stat.461.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #print(rounds)
                missed_frwy_other_percent = stat_record[4]
                #print(sg_app_green_avg)
                total_missed_other = stat_record[5]
                #print(total_sg_app_green)
                possible_fairways = stat_record[6]
                #print(measured_rounds)
                relative_to_par = stat_record[7]
                stat_data.append([year_id,rank,player_name,rounds,missed_frwy_other_percent,total_missed_other,possible_fairways,relative_to_par])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','missed_frwy_other_percent','total_missed_other','possible_fairways','relative_to_par'])
