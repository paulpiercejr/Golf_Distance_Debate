...
docTitle = 'one_putt_percent'
url = 'https://www.pgatour.com/stats/stat.413.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','one_putt_percent','num_one_puttsl','num_holes'])
