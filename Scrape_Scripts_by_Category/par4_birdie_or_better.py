...
docTitle = 'par4_birdie_or_better'
url = 'https://www.pgatour.com/stats/stat.113.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                par4_holes = stat_record[6]
                #print(measured_rounds)
                stat_data.append([year_id,rank,player_name,rounds,birdie_plus_percent,total_birdie_or_better,par4_holes])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','birdie_plus_percent','total_birdie_or_better','par4_holes'])
