...
docTitle = 'proximity_to_hole'
url = 'https://www.pgatour.com/stats/stat.331.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','avg_proximity','total_distance_ft','num_att','gir_rank'])
