...
docTitle = 'putting_avg'
url = 'https://www.pgatour.com/stats/stat.104.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','putting_avg','gir_putts','greens_hit','birdie_conversion'])
