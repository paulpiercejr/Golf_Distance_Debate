...
docTitle = 'putts_per_round'
url = 'https://www.pgatour.com/stats/stat.119.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','putt_per_round','total_putts','total_rounds','low_total_putts'])
