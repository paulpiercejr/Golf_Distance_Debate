...
docTitle = 'sg_approach_green'
url = 'https://www.pgatour.com/stats/stat.02568.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','sg_approach_avg','total_sg_app','measured_rounds'])
