...
docTitle = 'sg_putting'
url = 'https://www.pgatour.com/stats/stat.02564.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','sg_putting_avg','sg_putting_total','measured_rounds'])
