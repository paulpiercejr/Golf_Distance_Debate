...
docTitle = 'sg_tee_to_green'
url = 'https://www.pgatour.com/stats/stat.02674.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','sg_tee_green_avg','sg_off_tee','sg_approach','sg_around_green','measured_rounds'])
