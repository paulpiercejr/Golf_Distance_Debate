...
docTitle = 'stroke_differential_field_avg'
url = 'https://www.pgatour.com/stats/stat.02417.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #print(rounds)
                stroke_diff = stat_record[4]
                #print(sg_app_green_avg)
                player_score = stat_record[5]
                #print(total_sg_app_green)
                field_avg_score = stat_record[6]
                #print(measured_rounds)
                stat_data.append([year_id,rank,player_name,rounds,stroke_diff,player_score,field_avg_score])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','stroke_differential','player_score','field_avg_score'])
