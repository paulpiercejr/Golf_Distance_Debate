...
docTitle = 'three_putt_avoidance'
url = 'https://www.pgatour.com/stats/stat.426.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','three_putt_percent','total_3_putts','total_holes'])
