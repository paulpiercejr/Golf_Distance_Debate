...
docTitle = 'three_putts_per_round'
url = 'https://www.pgatour.com/stats/stat.400.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','per_round_avg','total_3_putts','total_rounds'])
