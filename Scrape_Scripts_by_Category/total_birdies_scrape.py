...
docTitle = 'total_birdies'
url = 'https://www.pgatour.com/stats/stat.107.y'
    ...
    if statTable:
        ...
        for tr in statTable.find_all('tr'):
            ...
            if count_tr > 0:
                ...
                #print(rounds)
                total_birdies = stat_record[4]
                #print(sg_app_green_avg)
                #num_birdies = stat_record[5]
                #print(total_sg_app_green)
                #total_rounds = stat_record[6]
                #print(measured_rounds)
                stat_data.append([year_id,rank,player_name,rounds,total_birdies])
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','total_birdies'])
