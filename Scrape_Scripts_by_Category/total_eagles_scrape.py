...
docTitle = 'total_eagles'
url = 'https://www.pgatour.com/stats/stat.106.y'
...
df_sd = pd.DataFrame(stat_data, columns = ['year','rank','player_name','rounds','total_eagles'])
